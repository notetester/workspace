...
public class MemberBoard {
	//주 테이블에 컬럼을 멤버변수, 부 테이브렝 대한 컬럼을 List표현
	private String id;
	private String pw;
	private String name;
	...
	public MemberBoard(String id, String pw, String name, String email, String address, ArrayList<Board01> list) {
		super();
		this.id = id;
		this.pw = pw;
		this.name = name;
